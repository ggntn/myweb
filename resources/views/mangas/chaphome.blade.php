                    ...
                    @foreach($chapters as $chapter)
                        ...
                        <div class="col-md-4">
                            <div class="card mb-4 shadow-sm">
                                ...
                                <div class="card-body">
                                    <b class="card-text"> {{ trans('site.manganame')}} : {{$manga->manga_name}}</b><br>
                                    <b class="card-text">{{ trans('site.chapter')}} : {{$chapter->chap_name}} </b>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <a href="/chap/{{$chapter->chap_name}}"{{$chapter->chap_name}} class="btn btn-sm btn-outline-secondary" role="button" aria-pressed="true">View</a>
