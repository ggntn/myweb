...
{{--@section('category')--}}
    {{--@foreach($categories as $category)--}}
        ...
        {{--<a class="dropdown-item" href="manga/{{$category->category_name}}">--}}
