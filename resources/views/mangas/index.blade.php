        ...
        @foreach($mangas as $manga)
                        ...
                        <div class="col-md-4">
                            <div class="card mb-4 shadow-sm">
                                ...
                                <div class="card-body">
                                    <b class="card-text"> {{ trans('site.manganame')}} : {{$manga->manga_name}}
                                        ...
                                        @foreach($categories as $category)
                                            <div>
                                                ...
                                                @if(($manga->category_id)==($category->category_id))
                                                    {{ trans('site.categories')}}  :
                                                    <span class="badge badge-success"> {{$category->category_name}}</span>
                                                    &nbsp
                                                @endif
                                            </div>
                                        @endforeach</b>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <a href="/manga/{{$manga->id}}"{{$manga->manga_name}} class="btn btn-sm btn-outline-secondary" role="button" aria-pressed="true">   {{ trans('site.detail')}}</a>
                                        </div>
